...
class Database
{
    ...
    {
        $this->link = mysqli_connect("localhost", "root", "", "webfast") or die();
    ...
    public  function fetchJone($table, $sql, $page, $row, $pagi = false)
    {
    ...
    public  function fetchJoneDetail($table, $sql, $page, $total, $pagi)
    {
        $result = mysqli_query($this->link, $sql) or die("Lỗi truy vấn fetchJone ---- " . mysqli_error($this->link));
